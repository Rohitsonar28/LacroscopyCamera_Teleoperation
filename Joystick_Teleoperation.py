...
TELE_SCALE = 2.0           # Stylus movement scaling factor
...
POSITIONS = [
    [-245.79, 393.93, 206.23, 88.48, -67.26, -176.79],  # Position 1 (Home)
    [-318.2,  144.9,  200.00, 180.0, 0.7414, 90.0],     # Position 2 
    [-450.0,  127.71, 330.00, 180.0, 0.7414, 90.0],     # Position 3 
    [-550.0,  126.0,  370.00, 180.0, 0.0,    90.0]      # Position 4 
]
